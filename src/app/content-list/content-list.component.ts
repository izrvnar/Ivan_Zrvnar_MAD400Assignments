...
export class ContentListComponent {
  ...
  constructor() {
    ...
    this.contentList.push({
      ...
      author: "Nintendo",
      imgSrc: "https://upload.wikimedia.org/wikipedia/en/c/c6/The_Legend_of_Zelda_Breath_of_the_Wild.jpg",
      type: "RPG",
      tags: ["open world", "action-adventure", "fantasy", "zelda"]
  ...
  this.contentList.push({
    ...
    imgSrc: "https://upload.wikimedia.org/wikipedia/en/6/65/World_of_Warcraft.png",
    type: "MMORPG",
  ...
  this.contentList.push({
    ...
    imgSrc: "https://upload.wikimedia.org/wikipedia/en/1/15/The_Elder_Scrolls_V_Skyrim_cover.png",
    type: "RPG",
